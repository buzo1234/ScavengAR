...
package com.example.kinnyblogs.cloudanchor;
...
import com.example.kinnyblogs.R;
import com.example.kinnyblogs.common.helpers.CameraPermissionHelper;
import com.example.kinnyblogs.common.helpers.DepthSettings;
import com.example.kinnyblogs.common.helpers.DisplayRotationHelper;
import com.example.kinnyblogs.common.helpers.FullScreenHelper;
import com.example.kinnyblogs.common.helpers.SnackbarHelper;
import com.example.kinnyblogs.common.helpers.TrackingStateHelper;
import com.example.kinnyblogs.common.rendering.BackgroundRenderer;
import com.example.kinnyblogs.common.rendering.ObjectRenderer;
import com.example.kinnyblogs.common.rendering.PlaneRenderer;
import com.example.kinnyblogs.common.rendering.PointCloudRenderer;
...
public class CloudAnchorActivity extends AppCompatActivity
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    String ARTYPE = intent.getStringExtra("AR_TYPE");

    System.out.println("type is " + ARTYPE);
    ...
    cloudidText = findViewById(R.id.cloudid);

    sharedPreferences = getSharedPreferences(PREFERENCE_FILE_KEY, Context.MODE_PRIVATE);

    // Initialize Cloud Anchor variables.
    if(ARTYPE.equals("HOST")){
      currentMode = HostResolveMode.HOSTING;
      String modelid = intent.getStringExtra("MODEL");
    ...
    }else if(ARTYPE.equals("RESOLVE")){
      String anchorid = intent.getStringExtra("ANCHOR_ID");
      ...
      CloudAnchorResolveStateListener resolveListener =
              new CloudAnchorResolveStateListener();

      cloudidText.setText(anchorid);
  ...
  public void onSurfaceCreated(GL10 gl, EGLConfig config) {
    ...
    try {
      ...
      if(model_no == 1){
        ...
        virtualObject.createOnGlThread(this, "models/anchor.obj", "models/anchor.png");
        virtualObject.setMaterialProperties(0.0f, 2.0f, 0.5f, 6.0f);
        virtualObjectShadow.setBlendMode(ObjectRenderer.BlendMode.Shadow);
        virtualObjectShadow.setMaterialProperties(1.0f, 0.0f, 0.0f, 1.0f);
      }
        ...
        virtualObject.createOnGlThread(this, "models/andy.obj", "models/anchor.png");
        virtualObject.setMaterialProperties(0.0f, 2.0f, 0.5f, 6.0f);
  ...
  private final class RoomCodeAndCloudAnchorIdListener
      implements CloudAnchorManager.CloudAnchorHostListener {
    ...
    public void onCloudTaskComplete(Anchor anchor) {
      ...
      intent.putExtra("anchor_id", cloudAnchorId);
      resetMode();
  ...
  private final class CloudAnchorResolveStateListener
    ...
    public void onCloudTaskComplete(Anchor anchor) {
      ...
      System.out.println("Anchor was resolved");
